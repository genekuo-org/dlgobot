...
def best_result(game_state, max_depth, eval_fn):
    ...
    for candidate_move in game_state.legal_moves():            # <3>
        ...
        opponent_best_result = best_result(next_state, max_depth - 1, eval_fn) # <5>
...
class DepthPruneAgent(Agent):
    ...
    def select_move(self, game_state):
        ...
        for possible_move in game_state.legal_moves():
            ...
            # Since our opponent plays next, figure out their bext possible outcome from there.
            opponent_best_outcome = best_result(next_state, self.max_depth, self.eval_fn)
            # Our outcome is the opposite of out opponent's outcome.
