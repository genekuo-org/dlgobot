...
# end::minimax-recursive-case[]
        # <1> See what the board looks like if we play this move.
        # <2> Find out our opponent's best move.
        # <3> Whatever our opponent wants, we want the opposite.
        # <4> See if the result is better than the best we've seen so far.
...
class MinimaxAgent(Agent):
    def select_move(self, game_state):
        ...
        for possible_move in game_state.legal_moves():
            ...
            # Since our opponent play next, figure out their best possible outcome from there.
