...
print(evaluate(data=train, digit=8, threshold=0.5, W=W, b=b))      # <1>

print(evaluate(data=test, digit=8, threshold=0.5, W=W, b=b))      # <2>

eight_test = [x for x in test if np.argmax(x[1]) == 8]
print(evaluate(data=eight_test, digit=8, threshold=0.5, W=W, b=b)) # <3>
